...
<AccordionGroup>
  ...
  <Accordion title="Is Membit free to use during the beta period?">
    ...
    more anytime by joining our [Discord](https://discord.gg/7TYEwVaTuk)
    community.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Are there rate limits for the API?">
    ...
    [reach out to us on Discord](https://discord.gg/7TYEwVaTuk) to discuss a
    custom plan.
  </Accordion>
  ...
  <Accordion title="Can I request a custom data pipeline or specific data sources?">
    ...
    [reach out on Discord](https://discord.gg/7TYEwVaTuk) to discuss your needs
    with our team.
  </Accordion>
</AccordionGroup>
