...
<Warning>
You'll need valid Membit API credentials. If you don't have access yet, [get your API key](/access-and-auth) to get started.
</Warning>
...
```python
# Async method
tools = await aget_tools_from_mcp_url("https://mcp.membit.ai/mcp/?Membit-Api-Key=<your-api-key>")
```
</Tab>
...
```python
# Synchronous method
tools = get_tools_from_mcp_url("https://mcp.membit.ai/mcp/?Membit-Api-Key=<your-api-key>")
```
</Tab>
</Tabs>
