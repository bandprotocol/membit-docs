---
title: "Cursor"
description: "Integrate real-time context to your Cursor AI Code Editor via Membit MCP."
icon: "); mask-image: url('/images/icons/cursor.png'); mask-size: 100% 100%;/*"
---

<img
  src="/images/cover/cursor.png"
  alt="Cover Image"
...
<Frame>
<img width="240" src="/images/cursor/setting.png" alt="Cursor settings interface showing configuration options" />
</Frame>
</Step>
